...
export type InstagramFileRefFragment = { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null };

type InstagramMediaRef_InstagramAd_Fragment = { __typename: 'InstagramAd', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null };

type InstagramMediaRef_InstagramPost_Fragment = { __typename: 'InstagramPost', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, childMedias: Array<{ __typename: 'InstagramAd' } | { __typename: 'InstagramPost', id: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramReel', id: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramStory' }> };

type InstagramMediaRef_InstagramReel_Fragment = { __typename: 'InstagramReel', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null };

type InstagramMediaRef_InstagramStory_Fragment = { __typename: 'InstagramStory', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null };

export type InstagramMediaRefFragment = InstagramMediaRef_InstagramAd_Fragment | InstagramMediaRef_InstagramPost_Fragment | InstagramMediaRef_InstagramReel_Fragment | InstagramMediaRef_InstagramStory_Fragment;

export type InstagramAccountRefFragment = { __typename?: 'InstagramAccount', id: string, username: string, name?: string | null, biography?: string | null, website?: string | null, permissions: Array<InstagramPermission>, profilePicture?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null };

export type InstagramPublishedRefFragment = { __typename?: 'InstagramPublishedMedia', id: string, permalink: string };

export type InstagramAccountStateQueryVariables = Exact<{
  botID: Scalars['BotID']['input'];
}>;


export type InstagramAccountStateQuery = { __typename?: 'Query', bot: { __typename?: 'Bot', id: string, contactScopes: Array<{ __typename: 'FacebookContactScope', id: string } | { __typename: 'InstagramAccountContactScope', id: string, instagramAccount: { __typename?: 'InstagramAccount', id: string, username: string, name?: string | null, biography?: string | null, website?: string | null, permissions: Array<InstagramPermission>, profilePicture?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } } | { __typename: 'TikTokAccountContactScope', id: string } | { __typename: 'WebWidgetContactScope', id: string } | { __typename: 'WhatsAppPhoneContactScope', id: string }> } };

export type InstagramLibraryQueryVariables = Exact<{
  botID: Scalars['BotID']['input'];
...
export type InstagramLibraryQuery = { __typename?: 'Query', bot: { __typename?: 'Bot', id: string, instagramMediasConnection: { __typename?: 'InstagramMediasConnection', edges: Array<{ __typename?: 'InstagramMediasEdge', cursor: string, node: { __typename: 'InstagramAd', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramPost', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, childMedias: Array<{ __typename: 'InstagramAd' } | { __typename: 'InstagramPost', id: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramReel', id: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramStory' }> } | { __typename: 'InstagramReel', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramStory', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } }>, pageInfo: { __typename?: 'InstagramMediasPageInfo', hasNextPage: boolean, endCursor?: string | null } } } };

export type InstagramMediaOneQueryVariables = Exact<{
  botID: Scalars['BotID']['input'];
  id: Scalars['InstagramMediaID']['input'];
}>;


export type InstagramMediaOneQuery = { __typename?: 'Query', bot: { __typename?: 'Bot', id: string, contactScopes: Array<{ __typename: 'FacebookContactScope', id: string } | { __typename: 'InstagramAccountContactScope', id: string, instagramAccount: { __typename?: 'InstagramAccount', id: string, media?: { __typename: 'InstagramAd', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramPost', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, childMedias: Array<{ __typename: 'InstagramAd' } | { __typename: 'InstagramPost', id: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramReel', id: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramStory' }> } | { __typename: 'InstagramReel', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramStory', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | null } } | { __typename: 'TikTokAccountContactScope', id: string } | { __typename: 'WebWidgetContactScope', id: string } | { __typename: 'WhatsAppPhoneContactScope', id: string }> } };

export type InstagramFileQueryVariables = Exact<{
  id: Scalars['FileID']['input'];
}>;


export type InstagramFileQuery = { __typename?: 'Query', file: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } };

export type InstagramPublishImageMutationVariables = Exact<{
  botID: Scalars['BotID']['input'];
  input: InstagramPublishImageInput;
}>;


export type InstagramPublishImageMutation = { __typename?: 'Mutation', instagramAccountPublishImage: { __typename?: 'InstagramPublishedMedia', id: string, permalink: string } };

export type InstagramPublishReelMutationVariables = Exact<{
  botID: Scalars['BotID']['input'];
  input: InstagramPublishReelInput;
}>;


export type InstagramPublishReelMutation = { __typename?: 'Mutation', instagramAccountPublishReel: { __typename?: 'InstagramPublishedMedia', id: string, permalink: string } };

export type InstagramPublishStoryMutationVariables = Exact<{
  botID: Scalars['BotID']['input'];
  input: InstagramPublishStoryInput;
}>;


export type InstagramPublishStoryMutation = { __typename?: 'Mutation', instagramAccountPublishStory: { __typename?: 'InstagramPublishedMedia', id: string, permalink: string } };

export type InstagramPublishCarouselMutationVariables = Exact<{
  botID: Scalars['BotID']['input'];
  input: InstagramPublishCarouselInput;
}>;


export type InstagramPublishCarouselMutation = { __typename?: 'Mutation', instagramAccountPublishCarousel: { __typename?: 'InstagramPublishedMedia', id: string, permalink: string } };

export type InstagramRefetchMediasMutationVariables = Exact<{
  accountID: Scalars['InstagramAccountID']['input'];
  count: Scalars['Int']['input'];
}>;


export type InstagramRefetchMediasMutation = { __typename?: 'Mutation', instagramAccountRefetchLatestMedias: { __typename?: 'InstagramAccount', id: string, username: string, name?: string | null, biography?: string | null, website?: string | null, permissions: Array<InstagramPermission>, profilePicture?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } };

export type InstagramConnectUrlMutationVariables = Exact<{
  permGroup: InstagramPermissionGroupName;
  state?: InputMaybe<Scalars['String']['input']>;
}>;


export type InstagramConnectUrlMutation = { __typename?: 'Mutation', instagramOAuthMakeUrl: string };

export type InstagramMediaAddedSubscriptionVariables = Exact<{
  botID: Scalars['BotID']['input'];
}>;


export type InstagramMediaAddedSubscription = { __typename?: 'Subscription', botInstagramMediaAdded: { __typename: 'InstagramAd', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramPost', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, childMedias: Array<{ __typename: 'InstagramAd' } | { __typename: 'InstagramPost', id: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramReel', id: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramStory' }> } | { __typename: 'InstagramReel', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } | { __typename: 'InstagramStory', id: string, isUnknown: boolean, caption?: string | null, ownerUsername: string, url: string, file?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null, thumbnailPreview?: { __typename?: 'File', id: string, url: string, type: FileType, status: FileStatus, size?: number | null } | null } };
...
export const InstagramFileRefFragmentDoc = new TypedDocumentString(`
fragment InstagramFileRef on File {
  ...
  status
  size
}`, {"fragmentName":"InstagramFileRef"}) as unknown as TypedDocumentString<InstagramFileRefFragment, unknown>;
export const InstagramMediaRefFragmentDoc = new TypedDocumentString(`
...
}`, {"fragmentName":"InstagramMediaRef"}) as unknown as TypedDocumentString<InstagramMediaRefFragment, unknown>;
export const InstagramAccountRefFragmentDoc = new TypedDocumentString(`
...
}`, {"fragmentName":"InstagramAccountRef"}) as unknown as TypedDocumentString<InstagramAccountRefFragment, unknown>;
export const InstagramPublishedRefFragmentDoc = new TypedDocumentString(`
fragment InstagramPublishedRef on InstagramPublishedMedia {
  id
  permalink
}`, {"fragmentName":"InstagramPublishedRef"}) as unknown as TypedDocumentString<InstagramPublishedRefFragment, unknown>;
export const InstagramAccountStateDocument = new TypedDocumentString(`
...
${InstagramFileRefFragmentDoc}
${InstagramAccountRefFragmentDoc}`) as unknown as TypedDocumentString<InstagramAccountStateQuery, InstagramAccountStateQueryVariables>;
export const InstagramLibraryDocument = new TypedDocumentString(`
...
${InstagramFileRefFragmentDoc}
${InstagramMediaRefFragmentDoc}`) as unknown as TypedDocumentString<InstagramLibraryQuery, InstagramLibraryQueryVariables>;
export const InstagramMediaOneDocument = new TypedDocumentString(`
...
${InstagramFileRefFragmentDoc}
${InstagramMediaRefFragmentDoc}`) as unknown as TypedDocumentString<InstagramMediaOneQuery, InstagramMediaOneQueryVariables>;
export const InstagramFileDocument = new TypedDocumentString(`
query InstagramFile($id: FileID!) {
  file(id: $id) {
    ...InstagramFileRef
  }
}
${InstagramFileRefFragmentDoc}`) as unknown as TypedDocumentString<InstagramFileQuery, InstagramFileQueryVariables>;
export const InstagramPublishImageDocument = new TypedDocumentString(`
...
${InstagramPublishedRefFragmentDoc}`) as unknown as TypedDocumentString<InstagramPublishImageMutation, InstagramPublishImageMutationVariables>;
export const InstagramPublishReelDocument = new TypedDocumentString(`
...
${InstagramPublishedRefFragmentDoc}`) as unknown as TypedDocumentString<InstagramPublishReelMutation, InstagramPublishReelMutationVariables>;
export const InstagramPublishStoryDocument = new TypedDocumentString(`
...
${InstagramPublishedRefFragmentDoc}`) as unknown as TypedDocumentString<InstagramPublishStoryMutation, InstagramPublishStoryMutationVariables>;
export const InstagramPublishCarouselDocument = new TypedDocumentString(`
...
${InstagramPublishedRefFragmentDoc}`) as unknown as TypedDocumentString<InstagramPublishCarouselMutation, InstagramPublishCarouselMutationVariables>;
export const InstagramRefetchMediasDocument = new TypedDocumentString(`
...
${InstagramFileRefFragmentDoc}
${InstagramAccountRefFragmentDoc}`) as unknown as TypedDocumentString<InstagramRefetchMediasMutation, InstagramRefetchMediasMutationVariables>;
export const InstagramConnectUrlDocument = new TypedDocumentString(`
...
}`) as unknown as TypedDocumentString<InstagramConnectUrlMutation, InstagramConnectUrlMutationVariables>;
export const InstagramMediaAddedDocument = new TypedDocumentString(`
...
${InstagramFileRefFragmentDoc}
${InstagramMediaRefFragmentDoc}`) as unknown as TypedDocumentString<InstagramMediaAddedSubscription, InstagramMediaAddedSubscriptionVariables>;