...
| `references/platform-links.md` | Platform links: one-shot connection / access-refresh URLs for WhatsApp, Instagram, TikTok, Facebook pages — lifecycle, replace-on-create, the URL as credential, redirects, disconnecting a channel, the public side that is not for you |
