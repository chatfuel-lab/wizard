...
- Restyle the bubbles in `vendor/ui` chat components (`MessageBubble`, `MessageList`, `ThreadHeader`, `Composer`) — the flow builder's Test dock, the AI Agent Test panel and the Copilot reuse them.
